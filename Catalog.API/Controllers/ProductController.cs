...
namespace Catalog.Controllers
{
    ...
    public class ProductController : BaseController<Product, ProductDto, ProductRequestDto>
    {
        ...
        public async Task<ActionResult> SetCategories(string productId, IEnumerable<string> categoryIds)
        {
            try
            {
                await _productService.SetCategories(productId, categoryIds);
        ...
        public async Task<ActionResult> AssignCategories(string productId, IEnumerable<string> categoryIds)
        {
            try
            {
                await _productService.AssignCategories(productId, categoryIds);
        ...
        public async Task<ActionResult> RetainCategories(string productId, IEnumerable<string> categoryIds)
        {
            try
            {
                await _productService.RetainCategories(productId, categoryIds);
